...
PROPERTY_COMMENTS = 6
PROPERTY_TEMPLATE = 7
PROPERTY_LAST_AUTHOR = 8
PROPERTY_UUID = 9
PROPERTY_EDIT_TIME = 10
PROPERTY_LAST_PRINTED = 11
PROPERTY_CREATION_TIME = 12
PROPERTY_LAST_SAVED_TIME = 13
PROPERTY_VERSION = 14
PROPERTY_WORD_COUNT = 15
PROPERTY_RESTRICT = 16
PROPERTY_THUMBNAIL = 17
PROPERTY_CREATING_APP = 18
PROPERTY_SECURITY = 19
